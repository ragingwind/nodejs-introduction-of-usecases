...
# Node.js: Introduction of Usecases

> Out of browser, not only for web application but also using everywhere. Brief introduction to practical usecases in Node.js applications.
